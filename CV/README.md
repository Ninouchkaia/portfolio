...
| [COVID-19 Drug Repurposing via Network Medicine](04_Postdoc_INSERM/05_NetworkMedicine/)               | Evaluates how drugs perturb multilayer SARS-CoV-2 host networks to highlight mechanistically relevant candidates. | Which drugs perturb SARS-CoV-2 host networks?                          | Multilayer networks, bootstrap null models, z-score ranking                                                       | Network integration, bootstrap, z-scores       |
