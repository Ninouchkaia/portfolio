...
for genome in genome_list :
	...
	file_open.close()
	file_write = open("abundance_datasets/tables/tables_4/temp/%s_tabletemp1.txt" % genome, 'a+')
	...
	file_open.close()
	file_write = open("abundance_datasets/tables/tables_4/temp/%s_tabletemp2.txt" % genome, 'a+')
	...
	file_open = open("abundance_datasets/tables/tables_4/temp/%s_tabletemp2.txt" % genome, 'rU')
	temp_data = file_open.readlines()
	file_open.close()
	file_write = open("abundance_datasets/tables/tables_4/%s_table4.txt" % genome, 'a+')
	for line in temp_data : 
		line = line.split("\t")
		file_write.write("%s\t%s" % (line[112], line[113]))
