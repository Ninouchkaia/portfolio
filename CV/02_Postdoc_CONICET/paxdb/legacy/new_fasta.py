...
#this script is used to generate fasta files with "old" uniprot_id in agreement with the list of uniprot ids given by the pax db website, their mapping lists, etc
#this script reads fasta files generated by the retrieve tool from uniprot website
#and remaps replaced uniprot ids to the older ones.
