...
#to generate an intermediate fasta file that contains only the string ids that are listed in the datasets.
...
#print len(list_of_identifiant_prot)

handle_fasta = open("/home/nina/scripts/paxdb/abundance_datasets/fasta_files/paxdb-protein-sequences.fa") #opens the fasta file containing the sequences and their information
file_write = open("/home/nina/scripts/paxdb/abundance_datasets/fasta_files/processed_paxdb-protein-sequences.fa", 'a+')
for record in SeqIO.parse(handle_fasta, "fasta"):
	if record.id in list_of_identifiant_prot :
