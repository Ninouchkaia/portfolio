...
for genome in genome_list :
	...
	file_open = open("abundance_datasets/tables/tables_update/%s_tabletemp2_update.txt" % genome, 'rU')
	temp_data = file_open.readlines()
	file_open.close()
	file_write = open("abundance_datasets/tables/tables_update/%s_table_update.txt" % genome, 'a+')
	for line in temp_data : 
		line = line.split("\t")
		file_write.write("%s\t%s\t%s" % (line[110], line[112], line[115]))
