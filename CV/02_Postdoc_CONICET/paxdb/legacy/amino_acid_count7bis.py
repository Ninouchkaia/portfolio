...
for species in species_list:
	...
	table = open("/home/nina/scripts/paxdb/abundance_datasets/tables/acopier/%s_tablebis.txt" % species, "rU")
	table = table.readlines()
	file_write = open("/home/nina/scripts/paxdb/abundance_datasets/tables/tables_2bis/%s_table2bis.txt" % species,'a+')
