...
# purpose of the script is to generate files listing the unmapped string id for each mapping table / dataset.
...
for species in species_list:
	...
	final_mapping = open("/home/nina/scripts/paxdb/abundance_datasets/uniprot_id/%s_dataset.txt_uniprot_id" % species) #thats the mapping generated through uniprot + the mapping file given by paxdb
	...
	list_of_string_id_in_final_mapping = list(set(list_of_string_id_in_final_mapping)) # will eliminate multiple string id that may appear when mapped to different uniprot ids
