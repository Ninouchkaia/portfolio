...
# 5. Génération du XML BehaviorSpace (3 expériences stocha_best_via / stocha_knee_point / stocha_best_conc)
#  (script spécifique à écrire, qui lit netlogo_best_param_sets_... et produit experiment_file.xml)
