...
[`../CV/04_Postdoc_INSERM/03_Deconvolution`](../CV/04_Postdoc_INSERM/03_RNASeqDeconvolution)

## 2. Barcode Clonal Dynamics
High-throughput barcode counts → QC → DESeq2 → drug network correlation.  
[`CV/04_Postdoc_INSERM/07_Barcodes`](../CV/04_Postdoc_INSERM/07_BarcodesDrugScreening)
...
[`CV/04_Postdoc_INSERM/01/abm_pipeline`](../CV/04_Postdoc_INSERM/01_AgentBasedModel)

## 5. Amino-Acid Usage Evolution with PaxDB
Python toolkit for FASTA parsing, abundance loading, AA metrics and correlations.  
[`CV/02_Postdoc_CONICET/paxdb`](../CV/02_Postdoc_CONICET/paxdb)
