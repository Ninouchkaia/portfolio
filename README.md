...
# Nina Verstraete — Computational Biologist & Bioinformatics Researcher  

Welcome!  
I am a multidisciplinary researcher at the crossroads of **molecular biology**, **bioinformatics**, and **computational modeling**.  
My work bridges experimental biology, data science, and digital modeling to explore the complexity of biological systems — from protein evolution to tumor–immune dynamics.
...
It serves as a structured overview of my approach to **data analysis**, **modeling**, and **scientific reproducibility**, rather than a source code archive.

> 🧩 Each folder corresponds to a specific research phase (CRCT, CONICET, ENS) and contains Markdown files summarizing the objectives, methods, and results of individual projects.
...
## ⚙️ Methods & Reproducibility

These files describe general frameworks I use for bioinformatics analysis, FAIR data management, and visualization standards:

- [Analysis Workflow Template](methods_and_templates/analysis_workflow_template.md)  
- [FAIR Principles Checklist](methods_and_templates/FAIR_principles_checklist.md)  
- [Data Visualization Guidelines](methods_and_templates/data_visualization_guidelines.md)

---

## 🎨 Visuals & Figures

Illustrative diagrams and simulated results from my research and modeling work:  
→ [Visualizations folder](visualizations/)

*(All figures are schematic, anonymized, or generated from public data.)*

---

## 🧠 About Me

- **PhD in Molecular Biology & Functional Genomics** — ENS Paris / CNRS IBENS  
- **Postdoctoral Researcher** — INSERM CRCT, Toulouse  
- **Software Engineer** — Airbus Defence & Space (Capgemini)  
- **Languages:** French (native), English (fluent), Spanish (fluent)  
- **Fields of interest:** cancer systems biology, data reproducibility, generative modeling, open science  

---

## 🌐 Contact

📧 **verstraete.nina@gmail.com**  
🔗 [LinkedIn – Nina Verstraete](https://www.linkedin.com/in/nina-verstraete)  
📍 Toulouse, France  
...
This repository does **not** contain raw data or proprietary code.  
It focuses on **conceptual documentation, analytical methods**, and **scientific reproducibility** across the research projects I have contributed to.
