...
* a selection of **[computational projects](bioinfo_projects)**.

---

## [CV - Research Experience](CV)
...
## [Selection of Computational Research Projects](bioinfo_projects)
This directory highlights a few selected projects, directly accessible in an independent modules.

#### [1. COVID-19 Drug Repurposing via Network Medicine](CV/04_Postdoc_INSERM/05_NetworkMedicine/) 
...
#### [2. Tumor Ecosystem Modeling](04_Postdoc_INSERM/CV/01_AgentBasedModel/)
...
#### [3. Amino Acid Usage under Evolutionary Constraints](CV/02_Postdoc_CONICET/paxdb/)
...
#### [4. Predicting Response to Immunotherapy (GEMDECAN)](CV/04_Postdoc_INSERM/03_RNASeqDeconvolution/)
...
#### [5. Clonal Dynamics and scRNA-seq under Treatment](CV/04_Postdoc_INSERM/07_BarcodesDrugScreening/)
...
#### [6. Functional Modularity of Ankyrin Proteins and Partners](CV/02_Postdoc_CONICET/ANKYRIN_MODULARITY)
